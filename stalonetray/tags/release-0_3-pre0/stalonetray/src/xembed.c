...
int xclient_msg32(Display *dpy, Window dst, Atom type, long data0, long data1, long data2, long data3, long data4)
{
	XEvent ev;
...
int xembed_msg(Display *dpy, Window dst, long msg, long detail, long data1, long data2)
{
	int status;
	...
	status = xclient_msg32(dpy, dst, xa_xembed, CurrentTime, msg, detail, data1, data2);
